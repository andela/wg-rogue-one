...
router.register(r'users', core_api_views.RegisterUserViewSet, base_name='user_details')

# Exercises app
router.register(r'exercise', exercises_api_views.ExerciseViewSet, base_name='exercise')
router.register(r'exercises', exercises_api_views.ExercisesViewSet, base_name='exercises')
